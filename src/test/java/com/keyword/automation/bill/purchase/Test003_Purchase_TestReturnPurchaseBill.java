 ...
 * @author Amio_
 */
public class Test003_Purchase_TestReturnPurchaseBill {
    ...
    @Test
    // 测试新增销售单
    public void test_AddReturnPurchaseBill() {
        LogUtils.info("--------------------测试添加采购退货单--------------------");
        String billNo = BillKeyword.addBill("采购退货单", billWhole);
        BillKeyword.approveBill("采购退货单", billNo);
    }
